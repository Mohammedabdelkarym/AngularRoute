 ...
 * each of the subsequent app. This prevents strange results in applications, where otherwise
...
function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
  ...
  function jsonpReq(url, callbackId, done) {
    ...
    // - fetches local app via XHR and evals them
  ...
  * @example
      ...
      <example name="example.csp" module="cspExample" ng-csp="true">
        ...
        <file name="protractor.js" type="protractor">
          ...
          // as Safari does not load the page with Protractor's injected app,
...
!window.angular.$$csp() && window.angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8"; ng\\:form{display:block;}</style>');